            ...
            <DialogContent className="sm:max-w-lg p-6">
                ...
                <form onSubmit={submitHandler} className="space-y-4">
                    {['fullname', 'email', 'phoneNumber', 'bio', 'skills'].map((field, index) => (
                        <div key={index}>
                            <Label htmlFor={field} className="block font-medium">{field.charAt(0).toUpperCase() + field.slice(1)}</Label>
                            <Input
                                id={field}
                                name={field}
                    ...
                    <div>
                        <Label htmlFor="file" className="block font-medium">Resume</Label>
