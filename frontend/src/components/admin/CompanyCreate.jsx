        ...
        <div>
            ...
            <div className='max-w-4xl mx-auto px-4'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-2 my-10'>
                    <Button variant='outline' className='w-full md:w-auto' onClick={() => navigate("/admin/companies")}>Cancel</Button>
                    <Button className='w-full md:w-auto' onClick={registerNewCompany}>Continue</Button>
                </div>
            </div>
        </div>
    );
