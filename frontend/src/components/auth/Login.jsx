...
//                         <Link to="/signup" className="text-[#28B463]">
//                             Signup
//                         </Link>
//                     </span>
//                 </form>
...
const Login = () => {
    ...
    return (
        <div>
            <Navbar />
            <div className="max-w-lg mx-auto px-4 my-10">
                <form onSubmit={submitHandler} className="w-full border border-gray-200 rounded-md p-6">
                    ...
                    <p className="text-sm text-center">Don't have an account? <Link to="/signup" className="text-[#28B463]">Signup</Link></p>
                </form>
            </div>
        </div>
    );
